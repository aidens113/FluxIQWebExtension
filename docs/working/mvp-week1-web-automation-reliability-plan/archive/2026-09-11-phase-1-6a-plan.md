...
3. **Manifest contract extension** (`packages/test-contracts/src/scenario.ts`,
   ...
   gains the [Metrics](../../mvp-week1-web-automation-reliability-plan.md#metrics) fields; `BenchReport` type.
...
7. **Ten new fixtures**, one worker each, under
   ...
   [corpus](../../mvp-week1-web-automation-reliability-plan.md#fluxbench-week-1-corpus). Registry and `types.ts` edits are
