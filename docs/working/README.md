...
| [manual-panel-test-findings.md](./manual-panel-test-findings.md) | User for submission; senior supervisor agent for triage and closure | 160 | Capture manual panel, extension, recording, Flow creation, execution, repair, reuse, and performance findings so isolated workers can reproduce and fix them. | none |
