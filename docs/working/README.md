...
| [lab-port-allocation-plan.md](./lab-port-allocation-plan.md) | Senior supervisor agent | 72 | Make Testing Lab loopback-port selection reject ports that cannot actually be bound, without changing product runtime networking or the user's running panel. | none |
