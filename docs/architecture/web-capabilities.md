...
Wave 3. The rows and sections changed since, for uploads, tab changes, child
frames, confirmations and dynamic elements, were checked against source on
2026-09-13. The wire protocol and the recording path are in the
