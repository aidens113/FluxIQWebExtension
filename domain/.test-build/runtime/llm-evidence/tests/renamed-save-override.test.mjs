...
var failurePacket = () => sanitizeWebLlmSnapshotWithBindings(capturedRenamedRedesign, {
  budget: "failure",
...
var clickAction = { nodeId: "save-changes", definitionId: "web.output.dom-click", recordedTarget: { element: RECORDED_SAVE } };
...
var SAVE_AND_EXIT_SELECTOR = "main > form > section:nth-of-type(1) > div > button";
var capturedSaveAndExit = {
  ...capturedRenamedRedesign,
  interactiveElements: capturedRenamedRedesign.interactiveElements.filter((element) => !("testId" in element) || element.testId !== "discard-changes").map((element) => element.selector === RENAMED_SAVE_SELECTOR ? { tagName: "button", selector: SAVE_AND_EXIT_SELECTOR, text: "Save changes and exit", visibleText: "Save changes and exit", accessibleName: "Save changes and exit", implicitRole: "button", context: FORM_SECTION } : element)
};
