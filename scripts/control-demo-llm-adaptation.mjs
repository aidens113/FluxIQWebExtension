...
try {
  ...
  process.stderr.write(JSON.stringify({ status: "failed", failureCode: failureCode(error), providerCallCount: 0, ...await demoLauncherFailureDetail(error, secretLiterals) }) + "\n", () => process.exit(1));
}
