...
try {
  ...
  process.stderr.write(JSON.stringify({ status: "failed", message: "Proposal-only website exploration checkpoint failed", failureCode, ...await demoLauncherFailureDetail(error, secretLiterals) }) + "\n");
  process.exitCode = 1;
}
