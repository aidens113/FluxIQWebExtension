...
try {
  ...
  process.stderr.write(JSON.stringify({ status: "failed", message: "Provider-free exploration adaptation apply failed", reasonCode, providerCallCount: 0, ...await demoLauncherFailureDetail(error, secretLiterals) }) + "\n");
  process.exitCode = 1;
}
