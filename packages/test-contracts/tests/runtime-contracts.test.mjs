...
test("run evaluations enforce failure classification, finite metrics, unique invariants, and verdict consistency", () => {
  const evaluation = { schemaVersion: "0.3", runId: "run-1", verdict: "failed", failureCategory: "action.targeting", facilityFailure: null, invariants: [{ id: "target-found", passed: false, expected: "found", actual: "missing", evidenceSequences: [1] }], metrics: { latencyMs: 12 }, scenarioId: "basic-form", workflowId: null, variantId: null, repeatIndex: 0, lane: "flow", flowCreated: true, oracleVerdict: "failed", reportedVerdict: "failed", automationFailureReported: { category: "target_not_found" }, automationFailureExpected: null, harnessActivations: 0, durationMs: 12, actions: [], evidence: { sanitizedPacketBytes: [], rawSnapshotBytes: [], truncationCount: 0 }, llm: { mode: "disabled", profileId: null, calls: 0 }, extraction: null, harnessRecovery: null, adaptationCost: null, adaptationValidation: null, adaptationPersistence: null, adaptationReuse: null };
